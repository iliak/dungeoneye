...
namespace DungeonEye.Forms
{
	...
	/// </summary>
	public partial class DisableTargetControl : ActionBaseControl
	{
		/// <summary>
		/// 
		/// </summary>
		...
		public DisableTargetControl(DisableTarget script, Dungeon dungeon)
		{
			InitializeComponent();
		...
		private void TargetBox_TargetChanged(object sender, DungeonLocation target)
		{
			...
			((DisableTarget)Action).Target = target;
		}
