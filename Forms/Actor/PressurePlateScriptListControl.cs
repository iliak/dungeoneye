...
namespace DungeonEye.Forms
{
	...
	/// </summary>
	public partial class PressurePlateScriptListControl : UserControl
	{

		/// <summary>
		/// 
		/// </summary>
		public PressurePlateScriptListControl()
		{
			InitializeComponent();
		...
		private void ScriptListBox_DoubleClick(object sender, EventArgs e)
		{
			...
			new PressurePlateScriptForm(Scripts[ScriptListBox.SelectedIndex], Dungeon).ShowDialog();
		...
		{
			// Empty form
			PressurePlateScriptForm form = new PressurePlateScriptForm(null, Dungeon);
		...
		/// Scripts
		/// </summary>
		public IList<PressurePlateScript> Scripts
		{
			get
			{
				return scripts;
		...
		IList<PressurePlateScript> scripts;
